...
Gem::Specification.new do |spec|
  spec.name          = "quick_orders"
  spec.version       = QuickOrders::VERSION
  spec.authors       = ["Jonny Dalgleish"]
  spec.email         = ["fighella@gmail.com"]

  spec.summary       = %q{ Allow quick export of Shopify Orders }
  spec.description   = %q{ Full order exports from Shopify }
